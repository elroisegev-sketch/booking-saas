...
לקוחות שבוצעת מעבירה הורמונלית כגון-שחלות-מולטיסטיות,אנדומטריוזים בעיות הורמונלית רפואיות,בעיות במזון הזמא או לקוחות שנוטלות זרללת הורמונלית וחמקין שתוער הורמונלי זובר שתיוש לכן יש סיכוי שהטיפול לא יתמן בצורה מקסימלית חל איסור לבצע טיפול הרמת ריסים לפני שרותת ארקון
רק לאחר הצי נרא שנצח מענה שמתניקה לרישל ארקון יש אפשרות לבצע טיפול.

חל איסור לבצע טיפול הרמת ריסים לפני שבועות מביוק איסור הפיניק דלקות , שוורה , הרפס , מחלת-אובד אלרגיה בעיניו מעד איוזר,חריקים, וביס זלי דקליק , שוורה , הרפס , מחלת רפואיה , קרהונה וכו'.

חל איסור לבצע טיפול הרמת ריסים לללקוחות חולים
זרנים , שברה , ספורית , קרהונה וכו' .
