...
const GOOGLE_REVIEWS = [
  { name: 'Maayan Abay', when: 'היום', service: '', text: 'עבודה מקצועית פשוט מושלםםם' },
  { name: 'inbal danino', when: 'היום', service: '', text: 'ליאור מדהימה מקצועית. מקום ממש נקי למי שחשוב לה, לי זה משמעותי.' },
  { name: 'משפחת נמט', when: 'היום', service: '', text: 'ליאור עדינה וקשובה. עזרה מאוד לבת שלי לעבור את הטיפול שככ חששה ממנו.' },
  { name: 'שירה כהן', when: 'לפני 4 חודשים', service: "לק ג'ל", text: 'ממש ממש ממליצה על ליאור. קודם כל את נכנסת וישר מרגישה בנח. ליאור פשוט חמודה ברמות, מלא סבלנות וחיוך, פשוט נותנת לך להרגיש בנח. עבודה מדהימה — עשיתי אצלה לק ג׳ל ונשאר לי יציב וחזק, עבודה נקייה ויפה. לא תתחרטו ולא ממומן.' },
  { name: 'hagit danino', when: 'לפני 6 חודשים', service: 'ציפורניים וגבות', text: 'מקצועית מאוד, אסתטית, יצירתית. עושה אצלה גם ציפורניים וגם גבות. מאוד מרוצה מהתוצאות.' },
  { name: 'Halel Danino', when: 'לפני 6 חודשים', service: 'מניקור', text: 'הייתי אצל הרבה מניקוריסטיות. כשהגעתי אליה הפכתי ללקוחה קבועה כבר קרוב לשנתיים. מאוד מקצועית, חד משמעית שווה את הכסף.' },
  { name: 'נחמי פרידמן', when: 'לפני 4 חודשים', service: 'מניקור', text: 'ליאור המהממת! תמיד בחיוך, בנחת ובסבלנות. מקצוענית ודייקנית והעבודות שלה מושלמות ממש.' },
  { name: 'יעלה נדם', when: 'לפני 6 חודשים', service: 'עיצוב גבות, הרמת ריסים', text: 'הקוסמטיקאית הכי מקצועית וחמה שאני מכירה. מדהימה ומוכשרת.' },
  { name: 'תאיר נתן', when: 'לפני 6 חודשים', service: 'הרמת ריסים, מניקור', text: 'מקצועית ברמות. עבודה מהממת ויסודית.' },
  { name: 'Gabriella Green', when: 'לפני 4 חודשים', service: '', text: 'נעימה, אסתטית ותוצאות מהממות.' },
];
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '0.9rem', padding: '0 4px' }}>
        ...
        <p dir="ltr" style={{ margin: 0, color: 'rgba(161,23,56,0.4)', fontSize: '0.7rem', letterSpacing: '0.12em' }}>{i + 1} / {n}</p>
