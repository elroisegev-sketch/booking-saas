...
-- SMS reminders (persisted so Railway restarts/deploys do not lose scheduled sends)
...
CREATE INDEX IF NOT EXISTS idx_sms_reminders_due ON sms_reminders (status, scheduled_at);
